...
<body class="body counter-scroll dashboard show " >
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
                                                    ...
                                                    <li class="dropdown2"><a href="#">Property</a>
                                                        <ul>
                                                            ...
                                                            <li class="dropdown2"><a href="#">Property Map</a>
                                                                <ul>
                                                                    <li><a href="properties-map-v1.html">Property Map V1</a></li>
                                                                    <li><a href="properties-map-v2.html">Property Map V2</a></li>
                                                                    <li><a href="properties-map-v3.html">Property Map V3</a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                    </li>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo"><a href="index.html"><img src="assets/images/logo/logo.png" alt="" title=""></a></div>
                    ...
                    <div class="mobi-icon-box">
                        ...
                        <div class="box flex">
                            ...
                            <div class="content">
                                Email: <h4>themesflat@gmail.com</h4>
                            </div>
                        </div>
                    </div>
                </nav>
  ...
  <div class="left-menu">
    ...
    <div id="sidebar-menu">
        ...
        <div class="logo-box d-flex">
            <div class="logo">
                <a href="index.html">
                    <img src="assets/images/logo/logo3.png" alt="" title="" class="img-logo">
                    <img src="assets/images/logo/toggle-logo.png" alt="" title="" class="toggle-logo">
                </a>
            </div>
        </div>
  ...
  <div class="dashboard__content">
    ...
    <!-- Javascript -->
    <script src=<?=ASSET_URL . "https://cdn.jsdelivr.net/npm/chart.js@3.5.1/dist/chart.min.js" ?>></script>
    <script src=<?= ASSET_URL . "public/app/js/apexcharts.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/jquery.min.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/jquery.easing.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/jquery.nice-select.min.js" ?>></script>
    <script src=<?= ASSET_URL . "public/app/js/jquery.cookie.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/bootstrap.min.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/swiper-bundle.min.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/countto.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/plugin.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/shortcodes.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/main.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/dashboard-menu.min.js"?>></script>
    <script src=<?= ASSET_URL . "public/app/js/dashboard-menu.js"?>></script>
</body>
